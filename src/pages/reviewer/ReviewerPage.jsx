...
const ReviewerPage = (props) => {
    ...
    const detail= async(reviewer)=>{         
        setRightDrawerContent( <ReviewerForm reviewer={reviewer} action='detail' onClose={closeRightDrawer}/>)
        setOpenRightDrawer(true)
        setRightDrawerTittle('Reviewer Detail')
    }
    const edit= async(reviewer)=>{        
        setRightDrawerContent(<ReviewerForm reviewer={reviewer} update={update} action='edit' onClose={closeRightDrawer}/>)
        setOpenRightDrawer(true)
        ...
        <Grid wrap='nowrap' container justify='space-between' className={classes.header}>
            ...
            <Grid container wrap='nowrap' justify='flex-end' item xs={5} className={classes.headerToolbar}>
                ...
                <Protected current={currentAccess} only='W'>
                    <AddButton  text='Add Reviewer' action={addButtonClick} classes={classes.bigAddButton}/>
                </Protected>
