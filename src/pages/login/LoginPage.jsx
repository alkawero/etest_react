...
const LoginPage = (props) => {
    ...
    const [pahoaUserPersist, setPahoaUserPersist] = useLocalStorage('pahoaUserPersist', null);
    ...
    return(
        ...
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
            ...
            <form className={classes.form} noValidate>
                ...
                <ToggleButtonGroup value={role} exclusive onChange={roleChange} className={classes.toggleGroup}>
                    <ToggleButton value="student" style={{borderRadius:'5px 0 0 5px'}}>student</ToggleButton>
                    <ToggleButton value="officer" style={{borderRadius:'0 5px 5px 0'}}>officer</ToggleButton>
                </ToggleButtonGroup>
