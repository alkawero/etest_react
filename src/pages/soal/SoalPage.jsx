...
import SoalDetail from './SoalDetail';
...
const SoalPage = (props) => {
    ...
    const addButtonClick = () => {
        ...
        setTopDrawerContent(<SoalForm action='create' create={create} onClose={closeTopDrawer}  />)
    }
    ...
    const detail = async (obj) => {
        ...
        setTopDrawerContent(<SoalForm action='detail' soal={soal} onClose={closeTopDrawer} />)
        setOpenTopDrawer(true)
    ...
    const edit = async (p) => {
        ...
        setTopDrawerContent(<SoalForm action='edit' update={update} soal={soal} onClose={closeTopDrawer}  />)
        setOpenTopDrawer(true)
            ...
            <Grid wrap='nowrap' container justify='space-between' className={classes.header}>
                ...
                <Grid container wrap='nowrap' justify='flex-end' item xs={5} className={classes.headerToolbar}>
                    ...
                    <Protected current={currentAccess} only='W'>
                        <AddButton text='Add Soal' action={addButtonClick} classes={classes.bigAddButton} />
                    </Protected>
                                    ...
                                    <TableRow key={row.id} className={classes.tableRow}>
                                        ...
                                        <TableCell>
                                            <div className={clsx(classes.actionWrapper, 'actionWrapper')}>
                                                ...
                                                <Protected current={currentAccess} only='W'>
                                                    <SwitchButton tooltip='change status' action={() => toggle(row)} checked={row.active === 1 || row.active === true} />
                                                </Protected>
                                                <Protected current={currentAccess} only='W'>
                                        ...
                                        <TableCell>{row.indicators.join(',')}</TableCell>
...
export default connect(mapStateToProps)(SoalPage);