...
const LeftNavigation = (props) => {
  ...
  return (
    ...
    >
      {pages.map(page => (
        <ListItem key={page.navigation} button className={classes.listItem} onClick={() => handleClick(page)} selected={page.navigation === active.navigation}>
          <ListItemIcon className={classes.itemIcon}>
            {getIcon(page.icon)}
          </ListItemIcon>
          <ListItemText primary={page.navigation} className={classes.itemText} />
        </ListItem>
      ))}
