...
const RancanganPage = (props) => {
    ...
    const addButtonClick = () => {
        ...
        setTopDrawerContent(<RancanganForm action='create' create={create} onClose={closeTopDrawer}  />)
    }
    ...
    const detail = async (obj) => {
        ...
        setTopDrawerContent(<RancanganForm action='detail' rancangan={rancangan} onClose={closeTopDrawer} />)
        setOpenTopDrawer(true)
    ...
    const edit = async (p) => {
        ...
        setTopDrawerContent(<RancanganForm action='edit' update={update} rancangan={rancangan} onClose={closeTopDrawer}  />)
        setOpenTopDrawer(true)
            ...
            <Grid wrap='nowrap' container justify='space-between' className={classes.header}>
                ...
                <Grid container wrap='nowrap' justify='flex-end' item xs={5} className={classes.headerToolbar}>
                    ...
                    <Protected current={currentAccess} only='W'>
                        <AddButton text='Add Rancangan' action={addButtonClick} classes={classes.bigAddButton} />
                    </Protected>
...
export default connect(mapStateToProps)(RancanganPage);
