...
const SchedulePage = (props) => {
    ...
    const addButtonClick = () => {
        ...
        setTopDrawerContent(<ScheduleForm action='create' create={create} onClose={closeTopDrawer} />)
    }
    ...
    const detail = async (obj) => {
        ...
        setTopDrawerContent(<ScheduleForm action='detail' exam={exam} onClose={closeTopDrawer} />)
        setOpenTopDrawer(true)
    ...
    const edit = async (p) => {
        ...
        setTopDrawerContent(<ScheduleForm action='edit' update={update} exam={exam} onClose={closeTopDrawer} />)
        setOpenTopDrawer(true)
